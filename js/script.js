...
document.getElementById('BtnCadastrar').addEventListener('click', async function () {
    ...
    try {     
        const response = await fetch('https://registro-usuarios-4vdi.onrender.com/add-user', {
            method: 'POST',
            headers: {
...
async function fetchUsers() {
    try {
        const response = await fetch('https://registro-usuarios-4vdi.onrender.com/usuarios');
...
async function deleteUser(id) {
    ...
    try {                                                                   
        const response = await fetch(`https://registro-usuarios-4vdi.onrender.com/usuarios/${id}`, {
            method: 'DELETE',
        });
